...
gem install sensu-plugins-eye -P MediumSecurity
```
...
```
sensu_gem 'sensu-plugins-eye' do
  options('--prerelease')
  version '0.0.1'
end
```
...
```
gem_package 'sensu-plugins-eye' do
  options('--prerelease')
  version '0.0.1'
end
```
